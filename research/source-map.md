...
| --- | --- | --- | --- | --- |
| Web-standard obfuscation | `hidden-content-exfiltration`, `metadata-obfuscation-demo` | Greshake 2023, Verma and Yadav 2025, WASP 2025, Johnson 2025 | `uiuc-kang-lab/InjecAgent` | First-party adaptation |
...
| --- | --- | --- |
| 1 | `uiuc-kang-lab/InjecAgent` | Best first importer for content injection and behavioural-control payload families that already match TDDF's runtime model |
